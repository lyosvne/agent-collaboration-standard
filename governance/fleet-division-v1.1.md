...
type: "governance"
title: "编队分工"
signoff: "用户 2026-08-12（六角色与 ZCode 评审执行隔离）"
---
# 编队分工 v1.3：自进化系统全职能映射

> 签发: Qoder（主架构职能）| 裁定: 用户 | 日期: 2026-08-12
> 基线: 北极星 v1.5 + 协作协议 v2.3 + Pi 自进化治理规格 v1.0
...
| 设计互检 | **Qoder ↔ ZCode**（设计 + 独立风险评审） | 双方协议 |
...
| G6 | **Pi 成长治理（新能力上线把关）** | 无（新职能） | ⑥进化 | **流水线**: Pi 提案 → ZCode/Qoder/Mira 评审 → Trae/Kimi/Qoder/ZCode 受派实现 → 独立终审 → 用户按风险批准 | 认知更新与能力自改使用独立质量门，ZCode 不得自审 |
| G7 | **ECS 常态运维/灾备**（daemon 挂了谁救） | 无（新职能） | 全环节地基 | **Trae/Kimi 执行 + Pi 自愈 + 飞书告警** | ZCode 的本地执行能力不包含 SSH、部署、生产读写或 secrets |
...
ZCode     评审优先执行 / 知识吸收 / 分析 / 反哺 / 风险兜底 / 受派实现
