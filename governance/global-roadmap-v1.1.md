...
用户的稳定身份始终是**战略制定者、T3 决策者和最终裁判**，日常中央协调由 Pi 承担。下面的“阶段介入方式”只描述用户在不同成熟阶段需要投入多少，不重新定义用户身份。
...
**Pi ECS 已运行采集→反思→记忆→日报闭环；当前处于治理真源升级、六角色同步和能力晋级质量门收口阶段。CSM 产品功能保持冻结。（2026-08-08 更新）**
